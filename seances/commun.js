/* ==========================================================================
   ...
   Structure d'une séance :
   {
     ...
     lieu: "maison",               // "maison" ou "salle" -> sert au filtre
     materiel: ["barre de traction"],  // facultatif : affiché sur la fiche
     blocs: [ ... ]                // une séance = une suite de blocs
   }

   Deux façons de s'en servir :
   - en circuit : un bloc avec plusieurs exercices, répété en plusieurs tours ;
   - en séries droites (typique en salle) : un bloc par exercice, avec autant de
     tours que de séries. Voir seances/salle-haut.js.
...
/* Deux échauffements réutilisables : on les glisse dans les séances
   en écrivant simplement ECHAUFFEMENT_HAUT dans la liste des blocs. */
const ECHAUFFEMENT_HAUT = {
  nom: "Échauffement haut du corps · 5 minutes",
  tours: 1, pauseExos: 0, pauseTours: 0,
  exercices: [
    { nom:"Moulinets poignets",    type:"reps", objectif:15, secParRep:1, note:"Avant-bras fixes, dans les deux sens" },
    { nom:"Moulinets coudes",      type:"reps", objectif:15, secParRep:1, note:"Coudes fixes, dans les deux sens" },
    { nom:"Moulinets épaules",     type:"reps", objectif:15, secParRep:1, note:"Avant puis arrière" },
    { nom:"Torsions de buste",     type:"reps", objectif:15, secParRep:1, parCote:true, note:"Hanches fixes" },
    { nom:"Flexions de poignets",  type:"reps", objectif:5,  note:"À genoux, sur plusieurs angles : avant, intérieur, extérieur" },
...
const ECHAUFFEMENT_BAS = {
  nom: "Échauffement bas du corps · 3 minutes",
  tours: 1, pauseExos: 0, pauseTours: 0,
  exercices: [
...
/* Planning par défaut : une liste par jour, pour pouvoir en mettre plusieurs.
